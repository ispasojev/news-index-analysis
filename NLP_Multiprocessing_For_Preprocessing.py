...
customized_stopwords = ["and", "or", "either", "to",
                        ...
                        "am", "among", "amongst", "amoungst", "amount", "an", "and", "announce", "another",
                        "any", "anybody", "anyhow", "anymore", "anyone", "anything", "anyway", "anyways",
                        "anywhere", "ao", "ap", "apart", "apparently", "appear", "appreciate", "appropriate",
                        "approximately", "ar", "are", "aren", "arent", "aren't", "arise", "around", "as", "a's",
                        "aside", "ask", "asking", "associated", "at", "au", "auth", "av", "available", "aw",
...
def measure_time(name, code_snippet,
                 model_name_list=model_name_list, execution_time_list=execution_time_list):
...
test_dict = {"Joblib":[2, 3, 4, 8],
               "Ray":[2, 3, 4],
}

for library in test_dict.keys():
    for n_core in test_dict[library]:
        ...
        if library == "Joblib":
            ...
            try:
                ...
                pass
        measure_time("Y X Cores".replace("X", str(n_core)).replace("Y", library),
                     statement.replace("_CORES_", str(n_core)))
...
plt.title("Comparison of Multiprocessing Strategies")
plt.ylabel("Execution Time in Seconds")
plt.xlabel("Multiprocessing Approach")
plt.xticks(rotation=20)
plt.savefig(".\data\images\execution_time_plot_stopwords.png")
