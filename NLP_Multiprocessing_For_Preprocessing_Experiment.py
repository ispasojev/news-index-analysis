...
test_dict = {
    ...
    "#Stopwords": [100, 1000, 2070],
    #libraries and number of cores to test out
    "Libraries": {"Joblib": [2, 3, 4, 8], "Ray":[2, 3, 4],}
}
for number_of_stopwords in test_dict["#Stopwords"]:
    ...
    plt.title("Number of Stopwords: " + str(number_of_stopwords), fontsize=10)
    plt.ylabel("Execution Time in Seconds")
    plt.xlabel("Multiprocessing Approach")
    plt.axhline(min(execution_time_list), color="red")
    plt.xticks(rotation=20)
    plt.savefig(".\data\images\execution_time_plot_" + str(number_of_stopwords) + "_stopwords.png")
